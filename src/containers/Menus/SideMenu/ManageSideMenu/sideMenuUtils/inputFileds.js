    ...
    <Grid container spacing={2}>
      {props.FieldsData.fields.map((fields) => {
        ...
        if (fields.type === 'select') {
          return <SelectInputChips options={props.categories} props={props} fields={fields} />
        }
        if (fields.type === 'checkbox') {
          return <CheckboxInput selected={props.selected} color="primary" props={props} {...fields} />
        }
        if (fields.type === 'file') {
