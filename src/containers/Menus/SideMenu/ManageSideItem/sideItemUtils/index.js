...
function SideItemMenu({ title, menuAction, ...props }) {
        ...
        <Box minHeight={600} borderRadius={8} p={3} bgcolor={useTheme().palette.common.white}>
          ...
          <Grid container>
            ...
            <Box mt={3} width="100%">
              ...
              {
                items.items.map(item => <ListItem className={classes.itemList}>
                  ...
                  <Grid xs={6} item container alignItems="center" justify="flex-end">
                    ...
                    <Box mr={1}><Typography variant="subtitle2">{item.included ? 'Included' : `+$${item.additionalPrice}`}</Typography></Box>
...
}), { getSideMenuAction })(SideItemMenu)
